...
const AddLocationForm: React.FC<AddLocationFormProps> = ({ onSuccessNavigateTo, defaultVendorId }) => {
  ...
  const handleSubmitForm = async () => {
    try {
      ...
      const payload = {
        ...
        p_vendor_id: defaultVendorId || VENDOR_ID,
  ...
  const renderStep3Mapping = () => { return null; }; // unused function (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#1e293b' }}>
