    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div style={{ background: '#F8FAFC80', padding: '24px', borderRadius: '24px', border: '1px solid #F1F5F9' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end' }}>
            <Button variant="outline" style={{ height: '50px', gap: '8px', padding: '0 24px', borderRadius: '12px', color: '#3b82f6', borderColor: '#3b82f6' }}>
              <Plus size={18} /> Thêm
            </Button>
          </div>
        </div>
      ...
      <div style={{ background: '#F8FAFC80', padding: '24px', borderRadius: '24px', border: '1px solid #F1F5F9' }}>
        ...
        <div style={{ display: 'flex', gap: '24px', marginBottom: '32px' }}>
          ...
          <div style={{ flex: 1 }}><Input label="Tên món ăn" placeholder="VD: Cơm Gà Hải Nam" /></div>
          <div style={{ flex: 1 }}><Input label="Giá bán (VNĐ)" placeholder="0" rightIcon={<span>đ</span>} /></div>
        </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {[
              ...
              { label: 'Giá bán', icon: <Trash2 size={16} />, mapping: 'Giá bán', status: 'Bắt buộc', statusColor: '#ef4444' },
