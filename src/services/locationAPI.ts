...
const initialData: Partial<Location>[] = [
  ...
  { name: 'Quán Cà phê Cũ', address: 'Ngõ nhỏ, Phố nhỏ, HN', category: 'Cafe', userName: 'Le Van C', publishDate: '20/05/2023', status: 'Từ chối' },
  ...
  { name: 'Test Location #99', address: 'N/A', category: 'Khác', userName: 'Viet Tourist', publishDate: '14/06/2023', status: 'Từ chối' },
